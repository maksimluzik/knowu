...
## 3. User Obligations
* Registration: You must register for an account to use the App. By signing up or creating an account, you explicitly agree to these Terms and our Privacy Policy. You agree to provide accurate and complete information during registration and keep your account information up-to-date.
...
## 4. Profile Sharing and Interaction with Friends & AI
The App includes social features allowing you to connect with other users ("Friends") and share your personality scores and profiles.
* **Sharing with Friends**: By adding another user as a Friend, you authorize the App to share your personality scores and profiles with them.
* **AI Context and Opt-Out**: Your Friends may reference or include your profile in their conversations with the App's AI coach ("Ask AI") for comparative analysis or coaching context. You can opt out of this feature at any time through your profile settings by disabling **"Share profile with Ask AI"**. When disabled, Friends will no longer be able to include your personality profile in their AI conversations.
